...
nccreate(ancfile,'time_bounds','Dimensions',{'nv',2,'time',1}, 'Datatype','single', 'Format','classic');
...
ncwriteatt(ancfile,'/','Description',['MAR ST anomaly. Prepared for ISMIP6 by Heiko Goelzer (h.goelzer@uu.nl), IMAU, ', date ])
ncwriteatt(ancfile,'/','MAR-contact','xavierfettweis@uliege.be')
ncwriteatt(ancfile,'/','MAR-institute','University of Liege (Belgium)')

% Add attributes to variables
ncwriteatt(ancfile,varname, 'units', 'K m-1') ;
ncwriteatt(ancfile,varname, 'long_name', 'Surface temperature change with surface elevation') ;
